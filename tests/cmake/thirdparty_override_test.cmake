...
if (EXISTS "${VSAG_SOURCE_DIR}/extern/httplib/httplib.cmake")
    message (FATAL_ERROR "0.16 must not add httplib support")
endif ()
...
assert_equal ("${actual}" "VSAG_THIRDPARTY_OPENBLAS_0_3_23" "0.16 OpenBLAS pin")
vsag_thirdparty_pinned_variable (YAML_CPP 0.8.0 actual)
assert_equal ("${actual}" "VSAG_THIRDPARTY_YAML_CPP_0_8_0" "0.16 yaml-cpp pin")
