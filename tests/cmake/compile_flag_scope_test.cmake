...
set (fixture_build "${CMAKE_CURRENT_BINARY_DIR}/vsag-compile-flag-scope-${fixture_suffix}")
...
reject_flag ("${thirdparty_command}" "-Ofast" "third-party C target")
reject_flag ("${thirdparty_command}" "-Werror" "third-party C target")
require_flag ("${thirdparty_command}" "-O3" "third-party Release target")
require_flag ("${thirdparty_command}" "_GLIBCXX_USE_CXX11_ABI=0" "third-party ABI definition")
...
require_flag ("${owned_c_command}" "-Ofast" "VSAG-owned C target")
require_flag ("${owned_c_command}" "-Werror" "VSAG-owned C target")
...
require_flag ("${owned_cxx_command}" "-Ofast" "VSAG-owned C++ target")
require_flag ("${owned_cxx_command}" "-Werror" "VSAG-owned C++ target")
require_flag ("${owned_cxx_command}" "_GLIBCXX_USE_CXX11_ABI=0" "VSAG-owned ABI definition")
...
reject_flag ("${owned_asm_command}" "-Ofast" "VSAG-owned ASM target")
reject_flag ("${owned_asm_command}" "-Werror" "VSAG-owned ASM target")
