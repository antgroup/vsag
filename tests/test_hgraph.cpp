...
TEST_CASE("HGraph conjugate graph feedback, update, and serialization",
    ...
    REQUIRE_FALSE(binary_mismatched->Deserialize(binary_mismatched_input).has_value());
    ...
    REQUIRE_FALSE(mismatched->DeserializeStreaming(enabled_mismatched_input).has_value());
