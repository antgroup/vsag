...
set(command "make;DYNAMIC_ARCH=1;PREFIX=/home/runner/work/vsag/vsag/build-test/openblas/install;install")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/runner/work/vsag/vsag/build-test/openblas/src/openblas-stamp/openblas-install-out.log")
set(stderr_log "/home/runner/work/vsag/vsag/build-test/openblas/src/openblas-stamp/openblas-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/runner/work/vsag/vsag/build-test/openblas/src/openblas-stamp/openblas-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "openblas install command succeeded.  See also /home/runner/work/vsag/vsag/build-test/openblas/src/openblas-stamp/openblas-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
