...
#
get_filename_component(filename "/home/runner/work/vsag/vsag/build_default/spdlog/src/spdlog-1.12.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/vsag/vsag/build_default/spdlog/source" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-spdlog${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-spdlog${i}")
