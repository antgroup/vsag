...
main(int argc, char** argv) {
    ...
    std::string precise_file_path = argc > 1 ? argv[1] : "vsag_cache_io_precise";

    /******************* Create HGraph Index with CacheIO on precise codes *****************/
    ...
    if (auto build_result = index->Build(base); build_result.has_value()) {
        std::cout << "After Build(), Index HGraph with CacheIO contains: "
