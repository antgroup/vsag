...
extern const char* const HGRAPH_BASE_CACHE_INNER_IO_TYPE;
extern const char* const HGRAPH_BASE_CACHE_TOTAL_SIZE;
extern const char* const HGRAPH_GRAPH_CACHE_INNER_IO_TYPE;
extern const char* const HGRAPH_GRAPH_CACHE_TOTAL_SIZE;
extern const char* const HGRAPH_PRECISE_CACHE_INNER_IO_TYPE;
extern const char* const HGRAPH_PRECISE_CACHE_TOTAL_SIZE;
extern const char* const HGRAPH_RAW_VECTOR_CACHE_INNER_IO_TYPE;
...
extern const char* const IVF_BASE_CACHE_INNER_IO_TYPE;
extern const char* const IVF_BASE_CACHE_TOTAL_SIZE;
extern const char* const IVF_PRECISE_CACHE_INNER_IO_TYPE;
