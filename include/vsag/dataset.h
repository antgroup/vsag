...
public:
   ...
   * @return DatasetPtr A shared pointer to the dataset with updated number of
   * elements.
   */
    virtual DatasetPtr
   ...
   * @return DatasetPtr A shared pointer to the dataset with updated
   * dimensionality.
   */
    virtual DatasetPtr
    Dim(int64_t dim) = 0;
   ...
   * @return DatasetPtr A shared pointer to the dataset with updated int8
   * vectors.
   */
    virtual DatasetPtr
   ...
   * @return DatasetPtr A shared pointer to the dataset with updated float32
   * vectors.
   */
    virtual DatasetPtr
   ...
   * @return DatasetPtr A shared pointer to the dataset with updated sparse
   * vectors.
   */
    virtual DatasetPtr
   ...
   *
   * @return DatasetPtr A shared pointer to the dataset with updated attribute
   * sets.
   */
    virtual DatasetPtr
