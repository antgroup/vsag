...
public:
     ...
     * The pointer is invalidated by destroying/assigning the owning set or by removing the key;
     * copy the pair to retain independent shared ownership.
     */
    [[nodiscard]] const UserDefinedIOPair*
