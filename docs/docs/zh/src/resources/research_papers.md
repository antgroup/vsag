...
## 3. EnhanceGraph: A Continuously Enhanced Graph-based Index for High-dimensional Approximate Nearest Neighbor Search [[axriv]](https://arxiv.org/abs/2506.13144)
...
## 4. SINDI: an Efficient Index for Approximate Maximum Inner Product Search on Sparse Vectors [[axriv]](https://arxiv.org/abs/2509.08395)
