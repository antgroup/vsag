...
`eval_performance` 的规范文档位于网站源码目录。

- 本地英文文档：[docs/docs/en/src/resources/eval.md](../../docs/docs/en/src/resources/eval.md)
- 本地中文文档：[docs/docs/zh/src/resources/eval.md](../../docs/docs/zh/src/resources/eval.md)
