...
vsag_get_system_dep_policy (MKL _vsag_dep_policy)

if (TARGET MKL::MKL AND NOT _vsag_dep_policy STREQUAL "OFF")
    if (NOT TARGET mkl)
        add_custom_target (mkl)
    endif ()
    add_library (vsag_mkl_headers INTERFACE)
    target_link_libraries (vsag_mkl_headers INTERFACE MKL::MKL)
    set (BLAS_LIBRARIES MKL::MKL CACHE STRING "Final list of BLAS libraries to link against." FORCE)
    vsag_note_system_dep (mkl MKL::MKL)
    return ()
elseif (NOT _vsag_dep_policy STREQUAL "OFF")
    ...
    elseif (_vsag_dep_policy STREQUAL "ON")
        vsag_fail_missing_system_dep (MKL MKL "MKL::MKL")
    endif ()
endif ()
