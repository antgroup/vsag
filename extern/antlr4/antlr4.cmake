...
vsag_get_system_dep_policy (ANTLR4 _vsag_dep_policy)
...
set (_vsag_external_antlr4_target "")
if (TARGET antlr4-runtime)
    set (_vsag_external_antlr4_target antlr4-runtime)
elseif (TARGET antlr4_static)
    set (_vsag_external_antlr4_target antlr4_static)
elseif (TARGET antlr4-runtime::antlr4-runtime)
    set (_vsag_external_antlr4_target antlr4-runtime::antlr4-runtime)
...
if (_vsag_external_antlr4_target)
    if (NOT TARGET antlr4)
        add_custom_target (antlr4)
    endif ()
    if (NOT TARGET antlr4-runtime)
        add_library (antlr4-runtime ALIAS ${_vsag_external_antlr4_target})
    endif ()
    add_library (vsag_antlr4_runtime_headers INTERFACE)
    target_link_libraries (vsag_antlr4_runtime_headers INTERFACE antlr4-runtime)
    add_library (vsag_antlr4_autogen_headers INTERFACE)
    target_include_directories (vsag_antlr4_autogen_headers INTERFACE extern/antlr4/fc)
    ...
    vsag_note_system_dep (antlr4 ${_vsag_external_antlr4_target})
    return ()
elseif (_vsag_dep_policy STREQUAL "ON")
    vsag_fail_missing_system_dep (ANTLR4 antlr4-runtime "antlr4-runtime, antlr4_static, antlr4-runtime::antlr4-runtime")
endif ()
