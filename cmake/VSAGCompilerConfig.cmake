...
elseif (MSVC)
    # Pure MSVC (not clang-cl): no extra flags needed here.
elseif (ENABLE_LIBCXX)
    message (FATAL_ERROR "gcc does not support using libc++")
endif ()

if (WIN32)
    # skip libc++/libstdc++ handling; MSVC runtime is used on Windows.
elseif (ENABLE_LIBCXX OR APPLE)
...
if (ENABLE_FRAME_POINTER AND NOT MSVC)
...
if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
    ...
    if (MSVC)
        vsag_add_cxx_compile_flag (-Wno-incompatible-pointer-types-discards-qualifiers)
    endif ()
endif ()
