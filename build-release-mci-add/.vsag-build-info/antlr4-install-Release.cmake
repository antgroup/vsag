...
set(command "cmake;--install;build")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/antlr4-install-out.log")
set(stderr_log "/root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/antlr4-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/antlr4-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "antlr4 install command succeeded.  See also /root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/antlr4-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
