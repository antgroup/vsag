...
set(command "cmake;--build;build;--target;install;--parallel;4")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/antlr4-build-out.log")
set(stderr_log "/root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/antlr4-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/antlr4-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "antlr4 build command succeeded.  See also /root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/antlr4-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
