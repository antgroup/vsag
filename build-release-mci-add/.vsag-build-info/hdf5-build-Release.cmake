...
set(stdout_log "/root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/hdf5-build-out.log")
set(stderr_log "/root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/hdf5-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/hdf5-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "hdf5 build command succeeded.  See also /root/vsag-hgraph-mci-companion/build-release-mci-add/.vsag-build-info/hdf5-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
