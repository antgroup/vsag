...
make_instance(const FlattenDataCellParameterPtr& param, const IndexCommonParam& common_param) {
...
FlattenInterfacePtr
FlattenInterface::MakeInstance(const FlattenDataCellParameterPtr& param,
