...
public:
    explicit GraphDataCell(const GraphInterfaceParameterPtr& graph_param,
                           const IndexCommonParam& common_param);

    explicit GraphDataCell(const GraphDataCellParameterPtr& graph_param,
                           const IndexCommonParam& common_param);
...
template <typename IOTmpl>
GraphDataCell<IOTmpl, false>::GraphDataCell(const GraphDataCellParameterPtr& param,
                                            const IndexCommonParam& common_param) {
...
template <typename IOTmpl>
GraphDataCell<IOTmpl, false>::GraphDataCell(const GraphInterfaceParameterPtr& param,
                                            const IndexCommonParam& common_param)
