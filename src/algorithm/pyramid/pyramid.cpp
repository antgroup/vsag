...
Pyramid::CheckAndMappingExternalParam(const JsonType& external_param,
    ...
    const ConstParamMap external_mapping = {
        ...
        {SAQ_AVG_BITS, {BASE_CODES_KEY, QUANTIZATION_PARAMS_KEY, SAQ_AVG_BITS_KEY}},
        {SAQ_SEGMENT_COUNT, {BASE_CODES_KEY, QUANTIZATION_PARAMS_KEY, SAQ_SEGMENT_COUNT_KEY}},
        {SAQ_ADJUSTMENT_ROUNDS,
         {BASE_CODES_KEY, QUANTIZATION_PARAMS_KEY, SAQ_ADJUSTMENT_ROUNDS_KEY}},
        {SAQ_USE_PCA, {BASE_CODES_KEY, QUANTIZATION_PARAMS_KEY, SAQ_USE_PCA_KEY}},
        {SAQ_RANDOM_ROTATION, {BASE_CODES_KEY, QUANTIZATION_PARAMS_KEY, SAQ_RANDOM_ROTATION_KEY}},
