...
public:
    FlattenDataCellParameterPtr base_codes_param_{nullptr};
    FlattenDataCellParameterPtr precise_codes_param_{nullptr};
    GraphInterfaceParameterPtr bottom_graph_param_{nullptr};
