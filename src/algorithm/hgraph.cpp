...
HGraph::AnalyzeIndexBySearch(const SearchRequest& request) {
    ...
    stats["recall_query"].SetFloat(static_cast<double>(result_hit) /
                                   static_cast<double>(num_elements * topk));
    stats["time_cost_query"].SetFloat(time_cost / static_cast<double>(num_elements));
