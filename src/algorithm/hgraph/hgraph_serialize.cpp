...
// size field written by BasicIO::Serialize
//
...
// BasicIO::Serialize emits the io size as one WriteObj and then the data, so a
...
// otherwise shift every recorded head boundary silently.
static uint64_t
io_size_field_bytes() {
