...
IVF::collect_streaming_header() const {
    ...
    AppendStreamingManifestBlock(
        manifest, bucket_tag, 1, StreamSerializationTagCritical(bucket_tag));
    AppendStreamingManifestBlock(
        manifest, partition_tag, 1, StreamSerializationTagCritical(partition_tag));
    AppendStreamingManifestBlock(manifest, label_tag, 1, StreamSerializationTagCritical(label_tag));
    if (this->use_reorder_) {
