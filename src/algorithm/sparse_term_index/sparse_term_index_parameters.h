...
struct SparseTermIndexParameters : public Parameter {
public:
    void
    ...
    SparseTermIndexParameters() = default;
...
using SparseTermIndexParameterPtr = std::shared_ptr<SparseTermIndexParameters>;
