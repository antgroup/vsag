...
#include "sparse_term_index_parameters.h"
...
void
SparseTermIndexParameters::FromJson(const JsonType& json) {
...
JsonType
SparseTermIndexParameters::ToJson() {
    JsonType json;
    ...
    json[DEFAULT_N_CANDIDATE] = n_candidate;
