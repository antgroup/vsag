...
TEST_CASE("SINDI Direct DMQ Scalar Oracle Test", "[ut][SINDI]") {
    ...
    float query_values[] = {1.0F, 0.5F, 1.0F};

    float term1_residuals[] = {-0.5F, 0.5F};
    float term4_residuals[] = {0.0F, 0.0F};
    float term9_residuals[] = {0.5F, -0.5F};
    ...
    REQUIRE(std::isfinite(approximate_inner_product));
    REQUIRE(std::abs(exact_inner_product - approximate_inner_product) < 1e-3F);
}
