...
MMapIOParameter::MMapIOParameter() : IOParameter(IO_TYPE_VALUE_MMAP_IO) {
}

MMapIOParameter::MMapIOParameter(const vsag::JsonType& json) : IOParameter(IO_TYPE_VALUE_MMAP_IO) {
