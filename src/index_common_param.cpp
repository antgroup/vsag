...
static void
fill_datatype(IndexCommonParam& result, JsonType datatype_obj) {
...
inline void
fill_metrictype(IndexCommonParam& result, JsonType metric_obj) {
...
inline void
fill_dim(IndexCommonParam& result, JsonType dim_obj) {
...
inline void
fill_extra_info_size(IndexCommonParam& result, JsonType extra_info_size_obj) {
