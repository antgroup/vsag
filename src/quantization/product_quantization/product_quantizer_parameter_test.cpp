...
TEST_CASE("Product Quantizer Parameter FromJson Partial Fields Test",
          "[ut][ProductQuantizerParameter]") {
...
TEST_CASE("Product Quantizer Parameter CheckCompatibility Test",
          "[ut][ProductQuantizerParameter]") {
