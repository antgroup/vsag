...
public:
    ...
    FP32Quantizer(const FP32QuantizerParameterPtr& param, const IndexCommonParam& common_param);

    FP32Quantizer(const QuantizerParameterPtr& param, const IndexCommonParam& common_param);
...
template <MetricType metric>
FP32Quantizer<metric>::FP32Quantizer(const FP32QuantizerParameterPtr& param,
                                     const IndexCommonParam& common_param)
    : FP32Quantizer<metric>(common_param.dim_, common_param.allocator_.get()) {
}

template <MetricType metric>
FP32Quantizer<metric>::FP32Quantizer(const QuantizerParameterPtr& param,
                                     const IndexCommonParam& common_param)
