...
public:
    ...
    explicit SQ4Quantizer(const SQ4QuantizerParameterPtr& param,
                          const IndexCommonParam& common_param);

    explicit SQ4Quantizer(const QuantizerParameterPtr& param, const IndexCommonParam& common_param);
...
template <MetricType metric>
SQ4Quantizer<metric>::SQ4Quantizer(const SQ4QuantizerParameterPtr& param,
                                   const IndexCommonParam& common_param)
    : SQ4Quantizer<metric>(common_param.dim_, common_param.allocator_.get()){};

template <MetricType metric>
SQ4Quantizer<metric>::SQ4Quantizer(const QuantizerParameterPtr& param,
                                   const IndexCommonParam& common_param)
