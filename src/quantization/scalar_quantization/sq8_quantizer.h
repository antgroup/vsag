...
public:
    ...
    SQ8Quantizer(const SQ8QuantizerParameterPtr& param, const IndexCommonParam& common_param);

    SQ8Quantizer(const QuantizerParameterPtr& param, const IndexCommonParam& common_param);
...
template <MetricType metric>
SQ8Quantizer<metric>::SQ8Quantizer(const SQ8QuantizerParameterPtr& param,
                                   const IndexCommonParam& common_param)
    : SQ8Quantizer<metric>(common_param.dim_, common_param.allocator_.get()) {
}

template <MetricType metric>
SQ8Quantizer<metric>::SQ8Quantizer(const QuantizerParameterPtr& param,
                                   const IndexCommonParam& common_param)
