...
public:
    ...
    explicit SQ4UniformQuantizer(const SQ4UniformQuantizerParameterPtr& param,
                                 const IndexCommonParam& common_param);

    explicit SQ4UniformQuantizer(const QuantizerParameterPtr& param,
                                 const IndexCommonParam& common_param);
...
template <MetricType metric>
SQ4UniformQuantizer<metric>::SQ4UniformQuantizer(const SQ4UniformQuantizerParameterPtr& param,
                                                 const IndexCommonParam& common_param)
    : SQ4UniformQuantizer<metric>(common_param.dim_, common_param.allocator_.get()){};

template <MetricType metric>
SQ4UniformQuantizer<metric>::SQ4UniformQuantizer(const QuantizerParameterPtr& param,
                                                 const IndexCommonParam& common_param)
