...
SQ8ComputeIP(const float* query,
    ...
    finalResult += avx::SQ8ComputeIP(query + i, codes + i, lowerBound + i, diff + i, dim - i);
    return finalResult;
#else
    return avx::SQ8ComputeIP(query, codes, lowerBound, diff, dim);
#endif
}
...
SQ8ComputeL2Sqr(const float* query,
    ...
    result += avx::SQ8ComputeL2Sqr(query + i, codes + i, lowerBound + i, diff + i, dim - i);
    return result;
#else
    return vsag::avx::SQ8ComputeL2Sqr(query, codes, lowerBound, diff, dim);  // TODO
#endif
}
...
SQ8ComputeCodesIP(const uint8_t* codes1,
    ...
    result += avx::SQ8ComputeCodesIP(codes1 + i, codes2 + i, lowerBound + i, diff + i, dim - i);
    return result;
#else
    return avx::SQ8ComputeCodesIP(codes1, codes2, lowerBound, diff, dim);
#endif
}
...
SQ8ComputeCodesL2Sqr(const uint8_t* codes1,
    ...
    result += avx::SQ8ComputeCodesL2Sqr(codes1 + i, codes2 + i, lowerBound + i, diff + i, dim - i);
    return result;
#else
    return avx::SQ8ComputeCodesL2Sqr(codes1, codes2, lowerBound, diff, dim);
#endif
}
