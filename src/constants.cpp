...
const char* const HGRAPH_EF_SEARCH = "hgraph_ef_search";
const char* const HGRAPH_MCI_EF_SEARCH = "mci_ef_search";
const char* const HGRAPH_MCI_SEED_MAX_COUNT = "mci_seed_max_count";
const char* const HGRAPH_MCI_EXPANSION_IDLE_WINDOW = "mci_expansion_idle_window";
const char* const HGRAPH_MCI_EXPANSION_LOWER_BOUND = "mci_expansion_lower_bound";
