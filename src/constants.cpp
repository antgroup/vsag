...
const char* const HGRAPH_BASE_CACHE_INNER_IO_TYPE = "base_cache_inner_io_type";
const char* const HGRAPH_BASE_CACHE_TOTAL_SIZE = "base_cache_total_size";
const char* const HGRAPH_GRAPH_CACHE_INNER_IO_TYPE = "graph_cache_inner_io_type";
const char* const HGRAPH_GRAPH_CACHE_TOTAL_SIZE = "graph_cache_total_size";
const char* const HGRAPH_PRECISE_CACHE_INNER_IO_TYPE = "precise_cache_inner_io_type";
const char* const HGRAPH_PRECISE_CACHE_TOTAL_SIZE = "precise_cache_total_size";
const char* const HGRAPH_RAW_VECTOR_CACHE_INNER_IO_TYPE = "raw_vector_cache_inner_io_type";
...
const char* const IVF_BASE_CACHE_INNER_IO_TYPE = "base_cache_inner_io_type";
const char* const IVF_BASE_CACHE_TOTAL_SIZE = "base_cache_total_size";
const char* const IVF_PRECISE_CACHE_INNER_IO_TYPE = "precise_cache_inner_io_type";
