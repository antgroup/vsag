...
const char* const HGRAPH_RABITQ_FUSED_CLUSTER_COUNT = "rabitq_fused_cluster_count";
const char* const HGRAPH_RABITQ_FUSED_KMEANS_ITERATIONS = "rabitq_fused_kmeans_iterations";
