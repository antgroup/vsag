...
const char* const TURBOQUANT_ENABLE_QJL_KEY = "turboquant_enable_qjl";
const char* const TURBOQUANT_QJL_PROJECTION_DIM_KEY = "turboquant_qjl_projection_dim";
...
const std::unordered_map<std::string, std::string> DEFAULT_MAP = {
    ...
    {"TURBOQUANT_BITS_PER_DIM_KEY", TURBOQUANT_BITS_PER_DIM_KEY},
    {"TURBOQUANT_ENABLE_QJL_KEY", TURBOQUANT_ENABLE_QJL_KEY},
    {"TURBOQUANT_QJL_PROJECTION_DIM_KEY", TURBOQUANT_QJL_PROJECTION_DIM_KEY},
