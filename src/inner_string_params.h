...
const char* const IO_TYPE_VALUE_READ_CACHE = "read_cache";
const char* const READ_CACHE_TOTAL_CACHE_SIZE_KEY = "total_cache_size";
const char* const READ_CACHE_EVICTION_STRATEGY_KEY = "eviction_strategy";
const char* const READ_CACHE_INNER_IO_TYPE_KEY = "inner_io_type";
...
const std::unordered_map<std::string, std::string> DEFAULT_MAP = {
    ...
    {"IO_TYPE_VALUE_READ_CACHE", IO_TYPE_VALUE_READ_CACHE},
    {"READ_CACHE_TOTAL_CACHE_SIZE_KEY", READ_CACHE_TOTAL_CACHE_SIZE_KEY},
    {"READ_CACHE_EVICTION_STRATEGY_KEY", READ_CACHE_EVICTION_STRATEGY_KEY},
    {"READ_CACHE_INNER_IO_TYPE_KEY", READ_CACHE_INNER_IO_TYPE_KEY},
