...
const char* const HGRAPH_RABITQ_FUSED_CLUSTER_COUNT_KEY = "rabitq_fused_cluster_count";
const char* const HGRAPH_RABITQ_FUSED_KMEANS_ITERATIONS_KEY = "rabitq_fused_kmeans_iterations";
