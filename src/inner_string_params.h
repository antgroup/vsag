...
const char* const IVF_SEARCH_PARAM_RABITQ_SEARCH_STRATEGY = "rabitq_search_strategy";
const char* const IVF_SEARCH_PARAM_RABITQ_SEARCH_STRATEGY_CANDIDATE_REORDER = "candidate_reorder";
const char* const IVF_SEARCH_PARAM_RABITQ_SEARCH_STRATEGY_HEAP = "heap";
...
const std::unordered_map<std::string, std::string> DEFAULT_MAP = {
    ...
    {"IVF_SEARCH_PARAM_RABITQ_SEARCH_STRATEGY", IVF_SEARCH_PARAM_RABITQ_SEARCH_STRATEGY},
