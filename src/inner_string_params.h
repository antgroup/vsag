...
const char* const HGRAPH_MCI_DELETE_CLIQUE_SIZE_THRESHOLD_KEY = "mci_delete_clique_size_threshold";
const char* const HGRAPH_MCI_DELETE_NODE_MCT_THRESHOLD_KEY = "mci_delete_node_mct_threshold";
