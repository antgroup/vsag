...
MutableSindiTermDataCell::QueryWindow(float* dists,
    ...
    while (computer->HasNextTerm()) {
        ...
        this->ScanPostingRange(it, computer, term_ids, term_data, selected.prefix_count, dists);
...
MutableSindiTermDataCell::FinalizeInsertBatch(MutableSINDIWindow& window, bool release_scratch) {
    ...
    struct PostingSortScratch {
        explicit PostingSortScratch(Allocator* allocator)
    ...
    std::optional<PostingSortScratch> scratch;
