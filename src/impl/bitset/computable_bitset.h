 ...
 *       It provides a set of methods that can be used to perform bitwise
...
public:
    ...
    /**
   * @brief Performs a bitwise OR operation on the current bitset with another
   * bitset.
   *
   ...
   */
    ...
    /**
   * @brief Performs a bitwise AND operation on the current bitset with another
   * bitset.
   *
   ...
   */
    ...
    /**
   * @brief Performs a bitwise XOR operation on the current bitset with another
   * bitset.
   *
   ...
   */
    ...
    /**
   * @brief Performs a bitwise OR operation on the current computable bitset
   * with another.
   *
   ...
   */
    ...
    /**
   * @brief Performs a bitwise AND operation on the current computable bitset
   * with another.
   *
   ...
   */
    ...
    /**
   * @brief Performs a bitwise XOR operation on the current computable bitset
   * with another.
   *
   ...
   */
    ...
    /**
   * @brief Performs a bitwise And operation on the current computable bitset
   * with a vector of other computable bitsets.
   *
   * @param other_bitsets The vector of computable bitsets to perform the And
   * operation with.
   * @return void
   */
    virtual void
   ...
   * with a vector of other computable bitsets.
   *
   * @param other_bitsets The vector of computable bitsets to perform the OR
   * operation with.
   * @return void
   */
    virtual void
   ...
   * with a vector of other computable bitsets.
   *
   * @param other_bitsets The vector of computable bitsets to perform the XOR
   * operation with.
   * @return void
   */
    virtual void
   ...
   * @return void
   * @note The serialized bitset is written to the stream in a format that can
   * be deserialized by the Deserialize method.
   */
    virtual void
   ...
   * @return void
   * @note The serialized bitset is read from the stream and deserialized into
   * the current bitset.
   */
    virtual void
